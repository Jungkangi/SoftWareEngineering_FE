  ...
  const generateCalendarDays = () => {
    ...
    for (let i = 0; i < 42; i++) {
      ...
      const activeSprint = sprints.find((sprint) => {
        ...
        return date >= sprintStart && date <= sprintEnd && (sprint.status === "active" || sprint.status === "planned")
      })
                  ...
                  {calendarDays.map((day, index) => (
                    ...
                    >
                      ...
                      <CalendarCellEvents>
                        ...
                        {day.todos.length > 3 && (
                          <EventsOverflow onClick={() => handleCellClick(day.date)}>
              ...
              <Card>
                <CardContent>
                  ...
                  {getTodosForDate(selectedDate).length > 0 ? (
                        ...
                        >
                          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                              ...
                              <span style={{ fontSize: "0.875rem", color: "#6b7280" }}>{todo.assignee}</span>
                            </div>
                          </div>
                        </div>
                      ))}
                    ...
                    <p style={{ color: "#6b7280", fontSize: "0.875rem" }}>No todos for this date</p>
                  )}
                </CardContent>
              </Card>
            )}
